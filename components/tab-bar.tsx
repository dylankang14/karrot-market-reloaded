...
export default function TabBar() {
	...
	return (
		<div className="fixed max-w-screen-sm mx-auto bottom-0 bg-neutral-900 left-0 right-0 w-full border-t border-neutral-600 grid grid-cols-5 *:text-white *:flex *:justify-center *:flex-col *:items-center *:p-2">
			<Link href="/product">
